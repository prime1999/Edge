	...
	return (
		...
		>
			...
			>
				...
				<div className="absolute left-7 top-30 md:hidden md:left-20">
					<UrusSvgSmall />
				</div>
				<div className="absolute -bottom-10 left-5 mx-auto w-11/12 h-1/4 text-white font-poppins font-bold md:bottom-50 md:left-12">
					<div className="flex items-center justify-between w-11/12 mx-auto text-xs md:w-9/12 md:text-sm">
						<motion.div
						...
						>
							<h4>0-6 Mph:</h4>
							<p className="text-gray-300 md:text-gray-500">2.5S</p>
						</motion.div>
						<motion.div
							initial={{ x: 20, opacity: 0 }}
							animate={{ x: 0, opacity: 1 }}
						...
						>
							<h4>Power:</h4>
							<p className="text-gray-300 md:text-gray-500">887Hp</p>
						</motion.div>
						<motion.div
							initial={{ x: 20, opacity: 0 }}
							animate={{ x: 0, opacity: 1 }}
